...
def visualize_clip_concept():
    ...
    for i, color in enumerate(colors):
        ...
        col = i % 2
        if color == 'red':
            grid_img[row*224:(row+1)*224, col*224:(col+1)*224] = [255, 0, 0]
        elif color == 'green':
            grid_img[row*224:(row+1)*224, col*224:(col+1)*224] = [0, 255, 0]
        elif color == 'blue':
            grid_img[row*224:(row+1)*224, col*224:(col+1)*224] = [0, 0, 255]
        elif color == 'yellow':
            grid_img[row*224:(row+1)*224, col*224:(col+1)*224] = [255, 255, 0]
